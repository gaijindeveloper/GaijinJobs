...
# Android Studio does not require libraryjars to be specified explicitly
# The dependency graph from maven does that automatically
# Ref: https://groups.google.com/forum/#!topic/adt-dev/Cy7qEYcPysU
# this may however be required for Eclipse, so a workaround may be required for

#-libraryjars proguard_annotations.jar
